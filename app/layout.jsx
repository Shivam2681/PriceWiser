    ...
    <html lang="en">
      <head>
        <style dangerouslySetInnerHTML={{__html: `
          ...
          #initial-loader .loader-ring {
            ...
            border-top-color: #E43030;
            border-radius: 50%;
            animation: spin 1s linear infinite;
          }
          #initial-loader .loader-ring-inner {
            position: absolute;
            inset: 15px;
          ...
          #initial-loader .loader-brand {
            display: flex;
            align-items: center;
            gap: 12px;
            margin-bottom: 16px;
          }
          #initial-loader .loader-brand svg {
            width: 32px;
            height: 32px;
          }
          ...
          #initial-loader .loader-progress {
            width: 200px;
            height: 3px;
            background: #f0f0f0;
            border-radius: 3px;
          ...
          #initial-loader .loader-progress-bar {
            width: 0%;
            height: 100%;
            background: linear-gradient(90deg, #E43030 0%, #ff6b6b 100%);
            border-radius: 3px;
      ...
      <body className={inter.className}>
        ...
        <div id="initial-loader">
          ...
          <div className="loader-subtext">Loading your deals...</div>
